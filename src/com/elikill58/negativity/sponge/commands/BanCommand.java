...
public class BanCommand implements CommandExecutor {
	...
	public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
		...
		BanRequest banRequest = new BanRequest(targetNPlayer.getPlayerId(), reason, System.currentTimeMillis() + banDuration, isBanDefinitive, src instanceof Player ? BanType.MOD : BanType.CONSOLE, getFromReason(reason), src.getName(), false);
		banRequest.execute();
