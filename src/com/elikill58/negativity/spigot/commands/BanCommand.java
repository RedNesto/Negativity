...
public class BanCommand implements CommandExecutor, TabCompleter {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] arg) {
		if (!(sender instanceof Player)) {
			...
			new BanRequest(np.getPlayerId(), reason, System.currentTimeMillis() + time, def, BanType.CONSOLE, getFromReason(reason), "admin", false).execute();
		...
		new BanRequest(np.getPlayerId(), reason, System.currentTimeMillis() + time, def, BanType.MOD, getFromReason(reason), p.getName(), false).execute();
